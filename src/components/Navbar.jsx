    ...
    <>
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          scrolled ? 'backdrop-blur-md bg-bg-base/80 border-b border-white/5 py-4' : 'bg-transparent py-6'
        }`}
      >
            ...
            {navLinks.map((link) => (
              <button
                ...
                className={`relative text-sm font-medium transition-colors hover:text-white ${
                  activeSection === link.id ? 'text-white' : 'text-text-secondary'
                }`}
              >
                {link.name}
              ...
              {navLinks.map((link) => (
                <button
                  ...
                  className={`text-xl py-3 font-medium transition-colors ${
                    activeSection === link.id ? 'text-purple-400' : 'text-text-secondary'
                  }`}
                >
                  {link.name}
                </button>
